...
class index extends Component{
  ...
  hideAlert = () => {
    ...
    if (this.state.message==="You have successfully add product"){
  ...
  async componentWillReceiveProps(nextProps){
    if (nextProps.isLoadingAdd === true) {
        this.setState({
            showAlert:true,
...
const mapStateToProps = state => ({
  ...
  isLoadingAdd:getProductField(state,"isLoadingAdd")
});
