...
class index extends React.Component{
  state={
    productstore:this.props.route.params.productstore,
    search:"",
    filterSearch:[],
    filter:"Default",
  }
  ...
  updateSearch = (search) => {
    ...
    if (search) {
      const newData=productstore.filter(
        function(product){
    ...
    else this.setState({filterSearch:productstore})
  ...
  render(){
    return(
      <View style={styles.container}>
        ...
        <SearchBar
          placeholder="Search In Shop Here..."
